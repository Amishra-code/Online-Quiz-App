<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.app.quiz.model.SportsQuiz, java.util.List"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container-home">
        ...
        <div style="color: white;">
		 ...
		 <form id="quizForm" action="/sportsQuizSubmit" method="post"> 
		 		<div id="timer"></div>
		        <%
		           List<SportsQuiz> sportsQuizContent = (List<SportsQuiz>) request.getAttribute("sportsQuizContent");
		           if (sportsQuizContent != null && !sportsQuizContent.isEmpty()) {
