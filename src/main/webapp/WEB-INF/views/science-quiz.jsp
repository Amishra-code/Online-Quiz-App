<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.app.quiz.model.ScienceQuiz, java.util.List"%>
<!DOCTYPE html>
<html>
<head>
	...
	<style><%@include file=".p./../css/style.css"%></style>
...
<body>
    <div class="container-home">
        ...
        <div style="color: white;">
		 ...
		 <form id="quizForm" action="/scienceQuizSubmit" method="post"> 
		 		<div id="timer"></div>
		        <%
		           List<ScienceQuiz> scienceQuizContent = (List<ScienceQuiz>) request.getAttribute("scienceQuizContent");
		           if (scienceQuizContent != null && !scienceQuizContent.isEmpty()) {
